...
Revision ID: 4a79998c7914
Revises: 
Create Date: 2026-09-11 19:06:23.525436
...
def upgrade() -> None:
    ...
    sa.Enum('VEGETARIAN', 'EGGETARIAN', 'NON_VEGETARIAN', 'VEGAN', 'PESCATARIAN', 'KETO', 'LOW_CARB', 'MEDITERRANEAN', 'OTHER', name='diettype').create(op.get_bind())
    ...
    sa.Enum('CHECKBOX', 'RADIO', 'TEXT', name='question_type').create(op.get_bind())
    ...
    sa.Column('created_at', sa.DateTime(), server_default=sa.text('now()'), nullable=False),
    sa.Column('updated_at', sa.DateTime(), server_default=sa.text('now()'), nullable=False),
    sa.ForeignKeyConstraint(['user_id'], ['users.id'], name=op.f('fk_user_workout_plans_user_id_users'), ondelete='CASCADE', use_alter=True),
    ...
    sa.Column('is_regeneration_required', sa.Boolean(), server_default='false', nullable=False),
    sa.Column('last_regeneration_check', sa.DateTime(), nullable=True),
    sa.Column('created_at', sa.DateTime(), server_default=sa.text('now()'), nullable=False),
    sa.Column('updated_at', sa.DateTime(), server_default=sa.text('now()'), nullable=False),
    sa.ForeignKeyConstraint(['current_plan_id'], ['user_workout_plans.id'], name=op.f('fk_users_current_plan_id_user_workout_plans'), ondelete='SET NULL'),
    ...
    sa.Column('created_at', sa.DateTime(), server_default=sa.text('now()'), nullable=False),
    sa.Column('updated_at', sa.DateTime(), server_default=sa.text('now()'), nullable=False),
    sa.ForeignKeyConstraint(['attendance_id'], ['user_attendance.id'], name=op.f('fk_workout_logs_attendance_id_user_attendance'), ondelete='CASCADE'),
...
def downgrade() -> None:
    ...
    sa.Enum('CHECKBOX', 'RADIO', 'TEXT', name='question_type').drop(op.get_bind())
    ...
    sa.Enum('VEGETARIAN', 'EGGETARIAN', 'NON_VEGETARIAN', 'VEGAN', 'PESCATARIAN', 'KETO', 'LOW_CARB', 'MEDITERRANEAN', 'OTHER', name='diettype').drop(op.get_bind())
