...
class UserGoalAnswers(Base):
    ...
    question_id: Mapped[uuid.UUID] = mapped_column(ForeignKey("goal_questions.id"), nullable=False)
    option_id: Mapped[uuid.UUID | None] = mapped_column(ForeignKey("goal_question_options.id"), nullable=True)
